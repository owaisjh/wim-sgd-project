...
function Roads (props: { Back: ((event: React.MouseEvent<SVGSVGElement, MouseEvent>) => void) | undefined; }) {
    ...
    // };
      ...
      function sendPostgresql(data: any){
        const response = fetch('https://mapify-backend.herokuapp.com/storeLandmark', {  //Hosted Apis on localhost:5000
          method: 'POST',
          headers:{
      ...
      function sendNeo4j(data: any){
        ...
        const response = fetch( 'https://mapify-backend.herokuapp.com/add_landmark' ,{  //Hosted Apis on localhost:5000
          method: 'POST',
          headers:{
            'Content-Type' : 'application/json',
          },
