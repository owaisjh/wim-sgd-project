...
function Roads (props: { Back: ((event: React.MouseEvent<SVGSVGElement, MouseEvent>) => void) | undefined; }) {
    ...
    // };
      ...
      function sendPostgresql(data: any){
        const response = fetch('https://3d45b39cec12.ngrok.io/storeLandmark', {  //Hosted Apis on localhost:5000
          method: 'POST',
          headers:{
      ...
      function sendNeo4j(data: any){
        ...
        const response = fetch( 'https://3d45b39cec12.ngrok.io/add_landmark' ,{  //Hosted Apis on localhost:5000
          method: 'POST',
          headers:{
            'Content-Type' : 'application/json',
          },
