...
function submitRoutePostgres(data: any){
  const response = fetch('https://39b62732f5fe.ngrok.io/storeRoutes', {  //Hosted Apis on localhost:5000
          method: 'POST',
          headers:{
...
function submitRouteNeo4j(data: any){
  const response = fetch('https://39b62732f5fe.ngrok.io/add_route', {  //Hosted Apis on localhost:5000
          method: 'POST',
          headers:{
            'Content-Type' : 'application/json',
          },
